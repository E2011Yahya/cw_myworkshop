...
```bash
aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 089319708029.dkr.ecr.us-east-1.amazonaws.com
```

- Then run the image

```bash
docker run --name todo -dp 80:3000 089319708029.dkr.ecr.us-east-1.amazonaws.com/clarusway-repo/todo-app:latest
```
