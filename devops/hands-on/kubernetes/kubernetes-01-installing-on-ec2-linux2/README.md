...
```bash
sudo kubeadm init --apiserver-advertise-address=172.31.71.235 --pod-network-cidr=172.16.0.0/16
```
...
```
kubeadm join 172.31.71.235:6443 --token 997m55.rmwty6lleomem3dl \
    --discovery-token-ca-cert-hash sha256:dcc4cef51bf12ea15bad38861d591de6fdaa93cb
...
- Activate the `Calico` pod networking and explain briefly the about network add-ons on `https://kubernetes.io/docs/concepts/cluster-administration/addons/`. Networking için. Yapılmazsa Node'lar birbirleri ile görüşemez.
...
```shell
sudo kubeadm token create  --certificate-key f75ab9a80080040aa3d34aab1cee8362afa26238a8fe72ed3b17ef796d99a46b --print-join-command
